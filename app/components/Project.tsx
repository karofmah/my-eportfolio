...
export default function Project(props:any){
    ...
    useEffect(() => {
      ...
      <div className="lg:bg-no-repeat lg:bg-cover lg:bg-center lg:h-screen mt-16 lg:duration-500 " style={innerWidth>=1024 ? {backgroundImage: `url(${props.image})`} : {}}>
   <div
        className={`flex flex-col lg:rounded-xl lg:absolute lg:right-0 lg:mr-16 lg:mt-12 bg-gradient-to-br from-blue-900 to-cyan-400 lg:overflow-hidden lg:opacity-95 hover:lg:h-fit lg:hover:w-3/5 duration-200 ${props.height} ${props.width} 
        `}
    ...
    {innerWidth >= 1024 && !isHovered && <KeyboardArrowDownIcon className="self-center animate-bounce"/>}
         <Typography ref={divRef} className='m-4 text-xs lg:text-md md:text-sm sm:text-sm xs:text-xs xl:text-lg 2xl:text-xl '>{props.object.description}</Typography>
       </div>
